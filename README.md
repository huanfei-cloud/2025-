...
- 具体任务
  1. 创建一个markdown文件，命名格式为{**{你的名字}LearnMarkdown.md**}，如‘小红LearnMarkDown.md’,写出简单的markdown语法使用（deepseek自学即可）。
  2. 创建一个markdown文件，命名格式为{**{你的名字}.md**}，如‘小红.md’，撰写你对本周题目的难度的看法/自己认为的难点。
  3. 创建一个markdown文件，命名格式为{**{你的名字}LearnGit.md**}，如‘小红LearnGit.md’，简述自己对**git组成以及常见命令使用原理的理解**。
