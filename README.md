...
## 各任务提交方式
### 整体提交形式
  - git提交+除git提交外各任务分别有一个整体文件夹放在一个总文件夹里（文件夹的命名**{学号}{姓名}{组别}第一周测试任务**），最后压缩成压缩包。
### 各部分具体提交形式
  ...
  - **CubeMX使用和CAN通信基础**：1. **任务一**（git提交）【具体要求在其任务里查看】
                                2. **任务二**  一个名为“CubeMX使用和CAN通信基础”的文件夹放 （word文档形式的优点1、3题答案）和（2题工程的压缩包）。
  - **电气元件基础**：一个名为“电气元件基础”的文件夹放（word文档形式的答案）。
  - **电源电路基础**：一个名为“电源电路基础”的文件夹放（word文档形式的答案）。
  - **线性降压电路设计**： 一个名为“线性降压电路设计”的文件夹放（word文档形式的3、4题的答案）和（压缩包形式的包含PCB原理图、用到的元件以及说明文档）。
...
## 各任务提交方式
### 整体提交形式
  - git提交+除git提交外各任务分别有一个整体文件夹放在一个总文件夹里（文件夹的命名**{学号}{姓名}{组别}第二周测试任务**），最后压缩成压缩包上传到北航云盘。
### 各部分具体提交形式
  - **底盘运动学结算**：一个名为“底盘运动学结算”的文件夹里放 （word文档形式的1题答案）和（）
  - **C/C++语言基础**：一个名为“C/C++语言基础”的文件夹里放 （文件形式的程序本身）和（照片形式的程序运行结果截图）
  - **嵌入式基础**：一个名为“嵌入式基础”的文件夹放 （word文档形式的答案）
  - **CubeMX使用和CAN通信基础**：1. **任务一**（git提交）【具体要求在其任务里查看】
                                2. **任务二**  一个名为“CubeMX使用和CAN通信基础”的文件夹放 （word文档形式的优点1、3题答案）和（2题工程的压缩包）。
